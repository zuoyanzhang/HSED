...
double getULP(double x, double origin) {
	mpfr_t mpfr_origin, mpfr_oracle, mp1, mp2, mp3, mp4, mp5, mp6;
	mpfr_inits2(128, mpfr_origin, mpfr_oracle, mp1, mp2, mp3, mp4, mp5, mp6, (mpfr_ptr) 0);
	mpfr_set_d(mp1, x, MPFR_RNDN);
	mpfr_exp(mp2, mp1, MPFR_RNDN);
	mpfr_set_d(mp3, 1, MPFR_RNDN);
	mpfr_sub(mp4, mp2, mp3, MPFR_RNDN);
	mpfr_set_d(mp5, x, MPFR_RNDN);
	mpfr_div(mp6, mp4, mp5, MPFR_RNDN);

	mpfr_set(mpfr_oracle, mp6, MPFR_RNDN);
	mpfr_set_d(mpfr_origin, origin, MPFR_RNDN);
	double ulp = computeULPDiff(mpfr_origin, mpfr_oracle);
	mpfr_clears(mpfr_origin, mpfr_oracle, mp1, mp2, mp3, mp4, mp5, mp6, (mpfr_ptr) 0);
	mpfr_free_cache();
	return ulp;
}
double getRelativeError(double x, double origin) {
	mpfr_t mpfr_origin, mpfr_oracle, mpfr_relative, mpfr_absolute, mp1, mp2, mp3, mp4, mp5, mp6;
	mpfr_inits2(128, mpfr_origin, mpfr_oracle, mpfr_relative, mpfr_absolute, mp1, mp2, mp3, mp4, mp5, mp6, (mpfr_ptr) 0);
	mpfr_set_d(mp1, x, MPFR_RNDN);
	mpfr_exp(mp2, mp1, MPFR_RNDN);
	mpfr_set_d(mp3, 1, MPFR_RNDN);
	mpfr_sub(mp4, mp2, mp3, MPFR_RNDN);
	...
	mpfr_clears(mpfr_origin, mpfr_oracle, mpfr_relative, mpfr_absolute, mp1, mp2, mp3, mp4, mp5, mp6, (mpfr_ptr) 0);
	mpfr_free_cache();
	return relative;
}
